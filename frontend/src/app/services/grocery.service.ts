...
export class GroceryService {
  ...
  addItemToList(listId: number, itemId: number, quantity: string, unit?: string): Observable<GroceryListItem> {
  ...
  toggleItemChecked(id: number): Observable<GroceryListItem> {
    return this.http.post<GroceryListItem>(`${this.apiUrl}/grocery-list-items/${id}/toggle_checked/`, {});
  }
