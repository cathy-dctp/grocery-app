...
SECRET_KEY = 'django-insecure-sg&x9y(he8)6ai$oq7rt56haq@_spy5xwq!1txc)r2o+eou2s*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '0.0.0.0', '*']  # Railway will be added later
...
# WhiteNoise configuration for serving Angular static files
STATICFILES_STORAGE = 'whitenoise.storage.CompressedStaticFilesStorage'

# Configure WhiteNoise to serve Angular files from root
