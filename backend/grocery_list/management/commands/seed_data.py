...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        categories_data = [
            ...
            {'name': 'Meat & Seafood', 'description': 'Fresh and frozen meat, poultry, seafood'},
            {'name': 'Pantry Staples', 'description': 'Rice, pasta, canned goods, spices'},
        ...
        items_data = [
            # Dairy & Eggs
            {'name': 'Whole Milk', 'category': 'Dairy & Eggs', 'unit': 'gallon', 'barcode': '123456789'},
        ...
        for item_data in items_data:
            item, created = Item.objects.get_or_create(
                ...
                defaults={
                    ...
                    'description': f"{item_data['name']} from {item_data['category']} section"
                }
            )
        ...
        checked_items = GroceryListItem.objects.filter(
            grocery_list=list1,
            item__name__in=['Spinach', 'Jasmine Rice']
        )
